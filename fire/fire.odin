...
main :: proc() {
    rl.InitWindow(FIRE_WIDTH * PIXEL_WIDTH, FIRE_HEIGHT * PIXEL_HEIGHT, "Doom Fire")
    ...
    for !rl.WindowShouldClose() {
        ...
        rl.DrawText("Doom Fire Demo", SCREEN_WIDTH - 250, 10, 30, rl.RAYWHITE)
...
create_fire_texture :: proc(fire: []int, target: rl.RenderTexture, draw_fps: bool) {
